...
int main(int argc, char *argv[])
{
	...
	if (argc < 5)
	{
		...
		cout << "** Функцiонал **\n";
		cout <<	"conv_ -v \"100\" -m \"HoursToSeconds\" - конвертувати 100 годин в секунди\n";
		cout << "conv_ -v \"100\" -m \"SecondsToHours\" - конвертувати 100 секунд в години\n";
		cout <<	"conv_ -v \"100\" -m \"KmToSM\" - конвертувати 100 кiлометрiв в сантиметри\n";
		cout << "Усi варiанти:\n";
